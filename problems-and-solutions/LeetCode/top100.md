...
| 29 | :orange_book: [49. Group Anagrams](https://leetcode.com/problems/group-anagrams/) | Hashing
...
| 88 | :orange_book: [347. Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements/) | Hash Table (Counter) / **Max Heap**
| 89 | :orange_book: [394. Decode String](https://leetcode.com/problems/decode-string/) | Stack
| 90 | :orange_book: [416. Partition Equal Subset Sum](https://leetcode.com/problems/partition-equal-subset-sum/) | Dynamic Programming | Hash Table (Sets)
| 91 | :orange_book: [437. Path Sum III](https://leetcode.com/problems/path-sum-iii/) | DFS with memorization
| 92 | :orange_book: [438. Find All Anagrams in a String](https://leetcode.com/problems/find-all-anagrams-in-a-string/) | Hashing + Sliding Window
| 93 | :green_book: [543. Diameter of Binary Tree](https://leetcode.com/problems/diameter-of-binary-tree/) | Binary Tree + DFS
| 94 | :orange_book: [560. Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/) | Prefix Sum + Dynamic Programming
| 95 | :orange_book: [647. Palindromic Substrings](https://leetcode.com/problems/palindromic-substrings/) | Dynamic Programming
| 96 | :orange_book: [739. Daily Temperatures](https://leetcode.com/problems/daily-temperatures/) | Stack
| 97 | :orange_book: [763. Partition Labels](https://leetcode.com/problems/partition-labels/) | Two Pointers
| 98 | :orange_book: [994. Rotting Oranges](https://leetcode.com/problems/rotting-oranges/) | Topological BFS on Grid/Matrix
| 99 | :orange_book: [1143. Longest Common Subsequence](https://leetcode.com/problems/longest-common-subsequence/) | Dynamic Programming
| 100 | :orange_book: [54. Spiral Matrix](https://leetcode.com/problems/spiral-matrix/) | Matrix and Array Manipulation
